java -jar compiler.jar --compilation_level ADVANCED_OPTIMIZATIONS --externs=externs\jquery.js --externs=externs\chrome.js  --js=js\xsddate.js --js=js\soapclient.js --js=js\jira.servers.js --js=js\jira.filters.js --js=js\jira.loader.js --js_output_file=js\jira.pack.js
