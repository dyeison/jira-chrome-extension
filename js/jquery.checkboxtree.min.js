...
$.widget("daredevel.checkboxTree", {
	_allDescendantChecked : function (a) {
		return (a.find("li input:checkbox:not(:checked)").length == 0)
	},
	_create : function () {
		var a = this;
		if (this.options.collapsable) {
			...
			this.element.find("li:has(ul):has(input:checkbox:checked)").each(function () {
				$(this).prepend($("<span />"));
				a.options.initializeChecked == "collapsed" ? a.collapse($(this)) : a.expand($(this))
			});
			this.element.find("li:has(ul):not(:has(input:checkbox:checked))").each(function () {
				$(this).prepend($("<span />"));
				a.options.initializeUnchecked == "collapsed" ? a.collapse($(this)) : a.expand($(this))
			});
			...
			if (this.options.onUncheck.node == "collapse") {
				this.element.find("input:checkbox:not(:checked)").live("click", function () {
					a.collapse($(this).parents("li:first"))
				})
			} else {
				if (this.options.onUncheck.node == "expand") {
					this.element.find("input:checkbox:not(:checked)").live("click", function () {
						a.expand($(this).parents("li:first"))
					})
				}
			}
	...
	_checkAncestors : function (a) {
		a.parentsUntil(".ui-widget").filter("li").find("input:checkbox:first:not(:checked)").attr("checked", true).change()
	},
	_checkDescendants : function (a) {
		a.find("li input:checkbox:not(:checked)").attr("checked", true).change()
	},
	_checkOthers : function (a) {
		a.addClass("exclude");
		a.parents("li").addClass("exclude");
		a.find("li").addClass("exclude");
	...
	_isRoot : function (a) {
		var b = a.parentsUntil(".ui-widget-daredevel-checkboxTree");
		return 0 == b.length
	},
	_markAsCollapsed : function (a) {
		if (this.options.expandAnchor.length > 0) {
			a.children("span").html(this.options.expandAnchor)
		} else {
			if (this.options.collapseUiIcon.length > 0) {
				a.children("span").removeClass(this.options.expandUiIcon).addClass("ui-icon " + this.options.collapseUiIcon)
			}
		}
		a.removeClass("expanded").addClass("collapsed")
	},
	_markAsExpanded : function (a) {
		if (this.options.collapseAnchor.length > 0) {
			a.children("span").html(this.options.collapseAnchor)
		} else {
			if (this.options.expandUiIcon.length > 0) {
				a.children("span").removeClass(this.options.collapseUiIcon).addClass("ui-icon " + this.options.expandUiIcon)
			}
		}
		a.removeClass("collapsed").addClass("expanded")
	},
	_markAsLeaf : function (a) {
		if (this.options.leafAnchor.length > 0) {
			a.children("span").html(this.options.leafAnchor)
		} else {
			if (this.options.leafUiIcon.length > 0) {
				a.children("span").addClass("ui-icon " + this.options.leafUiIcon)
			}
		}
		a.addClass("leaf")
	},
	_parentNode : function (a) {
		return a.parents("li:first")
	},
	_uncheckAncestors : function (a) {
		a.parentsUntil(".ui-widget").filter("li").find("input:checkbox:first:checked").attr("checked", false).change()
	},
	_uncheckDescendants : function (a) {
		a.find("li input:checkbox:checked").attr("checked", false).change()
	},
	_uncheckOthers : function (a) {
		a.addClass("exclude");
		a.parents("li").addClass("exclude");
		a.find("li").addClass("exclude");
		$(this.element).find("li").each(function () {
	...
	collapse : function (a) {
		if (a.hasClass("collapsed") || (a.hasClass("leaf"))) {
			return
		}
		var b = this;
		a.children("ul").hide(this.options.collapseEffect, {}, this.options.collapseDuration);
		setTimeout(function () {
			b._markAsCollapsed(a, b.options)
		}, b.options.collapseDuration);
		b._trigger("collapse", a)
	},
	...
	expand : function (a) {
		if (a.hasClass("expanded") || (a.hasClass("leaf"))) {
			return
		}
		var b = this;
		a.children("ul").show(b.options.expandEffect, {}, b.options.expandDuration);
		setTimeout(function () {
			b._markAsExpanded(a, b.options)
		}, b.options.expandDuration);
		b._trigger("expand", a)
	},
	expandAll : function () {
		var a = this;
	...
	uncheck : function (a) {
		a.find("input:checkbox:first:checked").attr("checked", false).change();
